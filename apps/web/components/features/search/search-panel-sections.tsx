              ...
              <span className="min-w-0 flex-1">
                <span className="flex min-w-0 items-center gap-2">
                  <span className="min-w-0 flex-1 truncate text-sm font-medium">
                    {section.heading ? highlightMatches(section.heading, result.query) : t("relatedMaterial")}
                  </span>
                ...
                <span className="mt-1 line-clamp-3 text-xs leading-relaxed text-muted-foreground">
                  {highlightMatches(section.content, result.query)}
                </span>
              </span>
            </button>
          );
      ...
      {events.map((event) => (
        ...
        >
          ...
          <span className="min-w-0 flex-1">
            <span className="flex min-w-0 items-center gap-2">
              <span className="min-w-0 flex-1 truncate text-sm font-medium">
                {event.title ? highlightMatches(event.title, result.query) : t("unnamedEvent")}
              </span>
            ...
            <span className="mt-1 line-clamp-2 text-xs leading-relaxed text-muted-foreground">
              {event.summary ? highlightMatches(event.summary, result.query) : t("noEventSummary")}
            </span>
          </span>
