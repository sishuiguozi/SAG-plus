...
def test_zleap_sag_sqlite_pool_compat_ignores_frontend_debug_env(monkeypatch, tmp_path):
    """Front-end tools may export DEBUG=release; zleap expects debug as bool."""
